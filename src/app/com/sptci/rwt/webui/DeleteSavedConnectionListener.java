 ...
 * @version $Id: DeleteSavedConnectionListener.java 3690 2007-11-09 16:41:04Z rakesh $
 */
public class DeleteSavedConnectionListener extends Listener<MainController>
{
   ...
   *   application
   */
  public DeleteSavedConnectionListener( final String databaseType,
  ...
  {
    Executor<DeleteSavedConnectionListener> executor =
      new Executor<DeleteSavedConnectionListener>( this, "delete" );
