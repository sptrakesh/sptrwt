 ...
 * @version $Id: ConnectionDialogue.java 3616 2007-10-14 20:16:46Z rakesh $
 */
public class ConnectionDialogue extends WindowPane
{
  ...
  private void initComponents()
  {
    ...
    grid.add( Utilities.createLabel(
          getClass().getName(), "databaseType", "Title.Label" ) );
    grid.add( createDatabaseType() );

    grid.add( Utilities.createLabel(
          getClass().getName(), "host", "Title.Label" ) );
    grid.add( Utilities.createTextField( getClass().getName(), "host", this ) );

    grid.add( Utilities.createLabel(
          getClass().getName(), "port", "Title.Label" ) );
    grid.add( createPort() );

    grid.add( Utilities.createLabel(
          getClass().getName(), "database", "Title.Label" ) );
    grid.add( Utilities.createTextField(
          getClass().getName(), "database", this ) );

    grid.add( Utilities.createLabel(
          getClass().getName(), "userName", "Title.Label" ) );
    grid.add( Utilities.createTextField(
          getClass().getName(), "userName", this ) );

    grid.add( Utilities.createLabel(
          getClass().getName(), "password", "Title.Label" ) );
    grid.add( Utilities.createTextField( getClass().getName(), "password",
          new ConnectListener( controller ), this ) );
  ...
  {
    String[] values =
      Configuration.getString( this, "databaseTypes" ).split( "," );
    ...
    databaseType.setWidth( Extent.getInstance(
          Dimensions.getInt( this, "databaseType.width" ) ) );
  ...
  protected Component createButtons()
  {
    ...
    row.add( Utilities.createButton( getClass().getName(),
          "connect", "Accept.Button", new ConnectListener( controller ) ) );
    row.add( Utilities.createButton( getClass().getName(),
          "cancel", "Cancel.Button", new CancelListener() ) );
    row.add( createSave() );
  ...
  {
    return ( ( port.getText().length() == 0 ) ? 0 :
  ...
  protected class DatabaseTypeListener implements ActionListener
  {
    ...
    {
      port.setText( Configuration.getString( ConnectionDialogue.this,
            databaseType.getSelectedItem().toString() + ".port" ) );
    }
  }
