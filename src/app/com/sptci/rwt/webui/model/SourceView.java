 ...
 * @version $Id: SourceView.java 3577 2007-10-08 04:02:38Z rakesh $
 */
public abstract class SourceView extends AbstractView
{
  ...
  {
    "select", "from", "where", "or", "and", "order by", "group by",
    "insert", "update", "into", "begin", "end", "as", "execute",
    "call", "for", "if", "return", "loop", "delete", "create",
    "drop", "procedure", "function", "table", "column", "view",
    "trigger", "index", "constraint", "primary", "foreign", "key",
    "type", "alter", "on", "cascade", "replace", "declare", "null",
    "raise", "exception", ":-", "is",
  };
