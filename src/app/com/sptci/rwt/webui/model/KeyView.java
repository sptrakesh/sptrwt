 ...
 * @version $Id: KeyView.java 3612 2007-10-13 23:59:53Z rakesh $
 */
public abstract class KeyView extends AbstractView
{
  ...
  protected Component createColumnDetails()
  {
    ...
    GroupBox box = new GroupBox(
        Configuration.getString( this, "column.title" ) );
    box.add( grid );
    return box;
  }
   ...
   *   be added.
   */
  protected void createCollectionLabels( final String name,
      final KeyMetaData kmd, final Component component )
  {
    int size = kmd.getColumns().size();
