 ...
 * {@link com.sptci.rwt.CatalogueMetaData}.
 *
 * <p>&copy; Copyright 2007 Sans Pareil Technologies, Inc.</p>
 * @author Rakesh Vidyadharan 2007-10-07
 * @version $Id: CatalogueView.java 3666 2007-10-30 13:30:31Z rakesh $
 * @since Version 1.1
 */
public class CatalogueView extends AbstractView
{
  /** The meta data object whose details are to be displayed. */
  private final CatalogueMetaData metaData;
   ...
   */
  public CatalogueView( final CatalogueMetaData metaData )
  {
  ...
  protected Component createDetails()
  {
    ...
    createLabels( "schemas", metaData, grid );
